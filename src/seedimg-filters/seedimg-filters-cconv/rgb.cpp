...
static constexpr seedimg::smat const rgb_ycbcr_bt601_mat = {298.082f / 256.0f,
                                                            298.082f / 256.0f,
                                                            298.082f / 256.0f,
                                                            0.0f / 256.0f,
                                                            -100.291f / 256.0f,
...
void ycbcr_jpeg2rgb_worker(simg& inp_img, simg& res_img, simg_int start, simg_int end) {
    for (; start < end; ++start) {
        for (simg_int x = 0; x < inp_img->width(); ++x) {
            ...
            // ry* is all 1. we do not need a lookup because it will all be the
            // same as pix.y gcb1 and bcr3 are zero in the matrix.
