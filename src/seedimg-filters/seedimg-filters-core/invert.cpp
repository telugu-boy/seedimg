...
void invert_worker(simg &inp_img, simg &res_img, simg_int start_row,
                   simg_int end_row) {
...
void invert_worker_alpha(simg &inp_img, simg &res_img, simg_int start_row,
                         simg_int end_row) {
  simg_int w = inp_img->width();
  for (; start_row < end_row; ++start_row) {
    for (simg_int x = 0; x < w; ++x) {
...
void invert_worker_alpha_only(simg &inp_img, simg &res_img, simg_int start_row,
                              simg_int end_row) {
  simg_int w = inp_img->width();
  for (; start_row < end_row; ++start_row) {
    for (simg_int x = 0; x < w; ++x) {
...
void invert_a_i(simg &inp_img, bool invert_alpha_only) {
