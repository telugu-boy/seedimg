...
void ycbcr(simg& inp_img, simg& res_img, seedimg::colourspaces type = seedimg::colourspaces::ycbcr_jpeg);
void ycbcr_i(simg& inp_img, seedimg::colourspaces type = seedimg::colourspaces::ycbcr_jpeg);
