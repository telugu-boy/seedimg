...
void apply_mat(simg& inp_img, simg& res_img, const fsmat& mat, cl::Buffer* inp_buf = nullptr,
               cl::Buffer* res_buf = nullptr);
void apply_mat_i(simg& inp_img, const fsmat& mat, cl::Buffer* inp_buf = nullptr);
void apply_mat(simg& inp_img, simg& res_img, const smat& mat, cl::Buffer* inp_buf = nullptr,
               cl::Buffer* res_buf = nullptr);
void apply_mat_i(simg& inp_img, const smat& mat, cl::Buffer* inp_buf = nullptr);

void rotate_hue(simg& inp_img, simg& res_img, float angle, cl::Buffer* inp_buf = nullptr,
                cl::Buffer* res_buf = nullptr);
void rotate_hue_i(simg& inp_img, float angle, cl::Buffer* inp_buf = nullptr);

void sepia(simg& inp_img, simg& res_img, cl::Buffer* inp_buf = nullptr, cl::Buffer* res_buf = nullptr);
void sepia_i(simg& inp_img, cl::Buffer* inp_buf = nullptr);

void grayscale(simg& inp_img, simg& res_img, cl::Buffer* inp_buf = nullptr, cl::Buffer* res_buf = nullptr);
void grayscale_i(simg& inp_img, cl::Buffer* inp_buf = nullptr);

namespace cconv {
void rgb(simg& inp_img, simg& res_img, cl::Buffer* inp_buf = nullptr, cl::Buffer* res_buf = nullptr);
void rgb_i(simg& inp_img, cl::Buffer* inp_buf = nullptr);

void hsv(simg& inp_img, simg& res_img, cl::Buffer* inp_buf = nullptr, cl::Buffer* res_buf = nullptr);
...
void exec_ocl_callback(simg& inp_img, simg& res_img, cl::Buffer* inp_buf, cl::Buffer* res_buf,
                       const std::string& kernel_name, Func&& callback, Args&&... kernel_args) {
    ...
    if (res_buf != nullptr) { res_img_buf = res_buf; }
    ...
    if (inp_buf == nullptr) delete inp_img_buf;
}
} // namespace ocl
} // namespace seedimg::filters
